...
[![Tests](https://img.shields.io/badge/tests-737%20passing-brightgreen.svg)](#)
...
- **737 tests** (Vitest, single run; re-run to verify: `npm run test:run`)
- Unit and integration tests; coverage: `npm run test:coverage`

```bash
npm run test:run     # One-shot run (canonical for CI/count)
npm test             # Watch mode
