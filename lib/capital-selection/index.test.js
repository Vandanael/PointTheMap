...
describe('Capital Selection Strategies', () => {
  ...
  describe('selectCountries', () => {
    ...
    it('should select correct number of countries', () => {
      const modeConfig = {
        countrySelection: { type: 'random', count: 5, balancing: { popular: 2, obscure: 3 } }
      };
    ...
    it('should work with seeded mode (daily variant)', () => {
      const modeConfig = {
        countrySelection: {
          type: 'seeded', count: 5, balancing: { popular: 2, obscure: 3 },
          seed: (date) => parseInt(date.toISOString().slice(0, 10).replace(/-/g, ''), 10)
        }
      };
  ...
  describe('selectStadiums', () => {
    const mockStadiums = [
      ...
      { name: 'Estadio Azteca', stadiumId: 'azt', lat: 19.30, lng: -99.15, popular: false },
    ...
    it('should select correct number of stadiums', () => {
      const modeConfig = {
        stadiumSelection: { type: 'random', count: 5, balancing: { popular: 2, obscure: 3 } }
      };
  ...
  describe('selectCivilizations', () => {
    ...
    it('should select correct number of civilizations', () => {
      const modeConfig = {
        civilizationSelection: { type: 'random', count: 5, balancing: { popular: 2, obscure: 3 } }
      };
