 ...
 *
 * @param {Object} modeConfig - Game mode configuration
 * @param {Array} dataSource - Array of civilizations
 * @param {Date} [date=new Date()] - Date for seeded selection
 * @returns {Array} Selected civilizations
 */
 ...
 *
 * @param {Object} modeConfig - Game mode configuration
 * @param {Array} dataSource - Array of stadiums
 * @param {Date} [date=new Date()] - Date for seeded selection
 * @returns {Array} Selected stadiums
 */
