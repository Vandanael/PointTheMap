...
/** Legacy V1 scoring constants (kept for reference and tests). */
export const SCORING_V1 = {
  ...
  LINEAR_END: 500,
  EXPONENTIAL_K: 280,
  LINEAR_SCORE_AT_END: 1000,
  EXPONENTIAL_TAIL: 800,
};
...
/** Shared speed bonus config for all modes (time-only, no distance gate). */
const SPEED_TIME_BONUS = {
  enabled: true,
  maxBonus: 1000,
  maxBonusPercent: 0.2,
};
...
export const SCORING = {
  TIME_BONUS_BY_MODE: {
    classic: SPEED_TIME_BONUS,
    daily: SPEED_TIME_BONUS,
    country: SPEED_TIME_BONUS,
    stadium: SPEED_TIME_BONUS,
    civilization: SPEED_TIME_BONUS,
    country_daily: SPEED_TIME_BONUS,
    stadium_daily: SPEED_TIME_BONUS,
    civilization_daily: SPEED_TIME_BONUS,
  },
};
