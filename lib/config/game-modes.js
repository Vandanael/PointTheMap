...
const MODE_CONFIG = {
  [MODE_IDS.CLASSIC]: {
    targets: (state) => state.targets ?? state.capitals, // Prefer domain model, fallback to legacy
  ...
  [MODE_IDS.DAILY]: {
    targets: (state) => state.targets ?? state.capitals,
    sessionTargetsKey: 'capitals',
    roundGameType: 'capital',
    noTargetsErrorKey: 'error.noTargetsCapitals',
  ...
  [MODE_IDS.COUNTRY]: {
    targets: (state) => state.targets ?? state.countries,
  ...
  [MODE_IDS.STADIUM]: {
    targets: (state) => state.targets ?? state.stadiums,
  ...
  [MODE_IDS.CIVILIZATION]: {
    targets: (state) => state.targets ?? state.civilizations,
